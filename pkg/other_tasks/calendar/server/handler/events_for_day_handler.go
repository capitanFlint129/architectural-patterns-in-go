...
func (c *eventsForDayHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	var (
...
func NewEventsForDayHandler(transport eventsForDayTransport, calendar service, errorTransport errorTransport) http.Handler {
